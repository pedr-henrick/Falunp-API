...
{
    public class PatchEnrollmentDtoValidator : AbstractValidator<EnrollmentUpdateDto>
    {
        private readonly IStudentRepository _studentRepository;
        private readonly IClassRepository _classRepository;

        public PatchEnrollmentDtoValidator(IStudentRepository studentRepository, IClassRepository classRepository)
        {
